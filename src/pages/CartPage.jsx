      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 shadow-md p-4 rounded-md ">
          {cartItems.map((item) => (
            <div
              key={item.id}
              className="flex items-center gap-4 py-4 border-b border-zinc-200"
            >
        ...
        <div className="lg:col-span-1 ">
          <div className="bg-white  shadow-md p-6 rounded-md">
            ...
            <div className="space-y-2 mb-4">
              ...
              <div className="border-t border-zinc-200 mt-4 pt-2 font-bold">
                <div className="flex justify-between">
            ...
            <button className="w-full bg-zinc-200 px-6 py-3 rounded-lg hover:lg-zinc-300 ">
              Proceed to checkout
            </button>
          </div>
        </div>
